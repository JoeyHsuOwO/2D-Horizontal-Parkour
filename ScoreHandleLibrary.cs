...
public class ScoreHandleLibrary : MonoBehaviour {
    ...
    static string Md5Sum(string s)
    {
        ...
        System.Security.Cryptography.MD5 l = System.Security.Cryptography.MD5.Create();
        byte[] data = l.ComputeHash(System.Text.Encoding.Default.GetBytes(s));
